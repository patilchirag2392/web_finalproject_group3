    ...
    <div className="aboutus-container">
      ...
      <Card
        sx={{
          ...
          marginBottom: "40px",
          backgroundColor: "#6A1B9A", // Base color for the card
        }}
      >
        <Box
          sx={{
            ...
            height: "100%",
            backgroundImage:
              "url('https://source.unsplash.com/random/1600x900/?education,technology')", // Dynamic background image
        ...
        <CardContent
          sx={{
            ...
            paddingY: { xs: '20px', md:'40px' }, // Responsive padding
